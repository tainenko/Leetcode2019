...
#  1) = 2, so ans[0] = -1. 
#  For i = 1, the smallest ans[1] that satisfies ans[1] OR (ans[1] + 1) = 3 is 1
# , because 1 OR (1 + 1) = 3. 
#  For i = 2, the smallest ans[2] that satisfies ans[2] OR (ans[2] + 1) = 5 is 4
# , because 4 OR (4 + 1) = 5. 
#  For i = 3, the smallest ans[3] that satisfies ans[3] OR (ans[3] + 1) = 7 is 3
# , because 3 OR (3 + 1) = 7. 
#  
# 
#  Example 2: 
...
#  
# 
#  Related Topics Array Bit Manipulation 👍 65 👎 10
