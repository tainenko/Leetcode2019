...
# of k. Your task is to hash the string s into a new string called result, which 
# has a length of n / k. 
# 
...
# 
#  
#  The hash value of a character is the index of that characte
#  r in the English alphabet (e.g., 'a' →
#  0, 'b' →
#  1, ..., 'z' →
#  25). 
...
#  
# 
#  Related Topics String Simulation 👍 49 👎 7
