...
# Similarly, an index i is part of a valley in nums if the closest non-equal neighbors of 
# i are larger than nums[i]. Adjacent indices i and j are part of the same hill or 
