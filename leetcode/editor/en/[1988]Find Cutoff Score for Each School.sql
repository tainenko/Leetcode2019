...
#Each row in this table indicates that there are student_count students that 
#got at least score points in the exam.
...
#recording a lower score. More formally, for every two rows i and j in the table, if 
#scorei > scorej then student_counti <= student_countj.
# 
#
# 
#
# Every year, each school announces a minimum score requirement that a student 
#needs to apply to it. The school chooses the minimum score requirement based on 
#the exam results of all the students: 
#
# 
...
#requirement, the school will get at most 10 applications, which is within capacity.
...
#requirement, the school will get at most 100 applications, which is within capacity.
#- School 9: The data given is not enough to determine the min score 
#requirement. Choosing 975 as the min score, the school may get 10 requests while its 
#capacity is 9. We do not have information about higher scores, hence we report -1.
# 
#
# Related Topics Database 👍 74 👎 140
