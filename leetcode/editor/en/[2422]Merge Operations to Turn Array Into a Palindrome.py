...
# 
#  
#  For example, if nums = [1,2,3,1], you can apply one operation to make it [1,5
# ,1]. 
#  
#  
# 
...
# Input: nums = [1,2,3,4]
# Output: 3
# Explanation: We do the operation 3 times in any position, we obtain the array 
# [10] at the end which is a palindrome.
#  
# 
#  
#  Constraints: 
...
#  
# 
#  Related Topics Array Two Pointers Greedy 👍 146 👎 16
