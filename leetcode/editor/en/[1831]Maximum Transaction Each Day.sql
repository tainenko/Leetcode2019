...
#table.
#"2021-4-28" --> We have two transactions with IDs 5 and 9. The transaction 
#with ID 5 has an amount of 40, while the transaction with ID 9 has an amount of 21. 
#We only include the transaction with ID 5 as it has the maximum amount this day.
#
#"2021-4-29" --> We have two transactions with IDs 1 and 6. Both transactions 
#have the same amount of 58, so we include both in the result table.
