...
# of the chosen candy is less than or equal to the minimum cost of the two candies 
# bought. 
# 
#  
#  For example, if there are 4 candies with costs 1, 2, 3, and 4, and the 
# customer buys candies with costs 2 and 3, they can take the candy with cost 1 for 
# free, but not the candy with cost 4. 
#  
# 
#  Given a 0-indexed integer array cost, where cost[i] denotes the cost of the 
# iᵗʰ candy, return the minimum cost of buying all the candies. 
# 
#  
#  Example 1: 
# 
...
#  
# 
#  Related Topics Array Greedy Sorting 👍 322 👎 11
