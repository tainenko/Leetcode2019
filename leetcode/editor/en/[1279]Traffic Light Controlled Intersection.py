...
# means when the light is green on road A, it is red on road B and when the light is 
# green on road B, it is red on road A. 
# 
#  Initially, the traffic light is green on road A and red on road B. When the 
# light is green on one road, all cars can cross the intersection in both 
# directions until the light becomes green on the other road. No two cars traveling on 
...
# intersection. Turning the light green on a road when it was already green is considered 
# a wrong answer. 
# 
#  
#  Example 1: 
# 
#  
# Input: cars = [1,3,5,2,4], directions = [2,1,2,4,3], arrivalTimes = [10,20,30,
# 40,50]
# Output: [
# "Car 1 Has Passed Road A In Direction 2",    // Traffic light on road A is 
# green, car 1 can cross the intersection.
...
# for road B.
# "Car 2 Has Passed Road B In Direction 4",    // Car 2 crosses as the light is 
# green on road B now.
...
# 
#  
# Input: cars = [1,2,3,4,5], directions = [2,4,3,3,1], arrivalTimes = [10,20,30,
# 40,40]
# Output: [
# "Car 1 Has Passed Road A In Direction 2",    // Traffic light on road A is 
# green, car 1 can cross the intersection.
...
# "Car 2 Has Passed Road B In Direction 4",    // Car 2 crosses as the light is 
# green on road B now.
# "Car 3 Has Passed Road B In Direction 3",    // Car 3 crosses as the light is 
# green on road B now.
# "Traffic Light On Road A Is Green",          // Car 5 requests green light 
# for road A.
# "Car 5 Has Passed Road A In Direction 1",    // Car 5 crosses as the light is 
# green on road A now.
# "Traffic Light On Road B Is Green",          // Car 4 requests green light 
# for road B. Car 4 blocked until car 5 crosses and then traffic light is green on 
# road B.
# "Car 4 Has Passed Road B In Direction 3"     // Car 4 crosses as the light is 
# green on road B now.
# ]
# Explanation: This is a dead-lock free scenario. Note that the scenario when 
# car 4 crosses before turning light into green on road A and allowing car 5 to 
# pass is also correct and Accepted scenario.
#  
# 
#  
#  Constraints: 
...
#  
#  Related Topics Concurrency 👍 49 👎 229
