...
#Each row of this table contains information about the date of a visit to the 
#store and the member who visited it.
# 
#
# 
#
...
#Each row of this table contains information about the amount charged in a 
#visit to the store.
# 
#
# 
...
#member) / total number of visits for the member. 
#
...
#+-----------+---------+----------+
#Explanation: 
#- User Narihan with id = 1 did not make any visits to the store. She gets a 
#Bronze category.
#- User Winston with id = 3 visited the store one time and did not purchase 
#anything. The conversion rate = (100 * 0) / 1 = 0. He gets a Silver category.
