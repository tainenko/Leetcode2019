...
# given player's score. If there is no player with such id in the leaderboard, add
# him to the leaderboard with the given score.
...
#
#
#  Related Topics Hash Table Design Sorting 👍 720 👎 92
...
class Leaderboard:
    ...
    def top(self, K: int) -> int:
        return sum([score for _, score in self.players.most_common(K)])
