...
# given direct access to the array, instead, you will have an API ArrayReader which 
# have the following functions: 
# 
#  
#  int compareSub(int l, int r, int x, int y): where 0 <= l, r, x, y < 
# ArrayReader.length(), l <= r and x <= y. The function compares the sum of sub-array arr[
# l..r] with the sum of the sub-array arr[x..y] and returns: 
#  
# 
#  
...
# reader.compareSub(0, 0, 1, 1) // returns 0 this is a query comparing the sub-
# array (0, 0) with the sub array (1, 1), (i.e. compares arr[0] with arr[1]).
...
#  
# 
#  Related Topics Array Binary Search Interactive 👍 208 👎 26
