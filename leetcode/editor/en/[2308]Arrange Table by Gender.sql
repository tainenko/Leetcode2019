...
# 
#
# Write an SQL query to rearrange the Genders table such that the rows 
#alternate between 'female', 'other', and 'male' in order. The table should be rearranged 
#such that the IDs of each gender are sorted in ascending order. 
#
