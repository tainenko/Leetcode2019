...
# iᵗʰ plant is located at x = i. There is a river at x = -1 that you can refill 
...
# completely water the next plant, return to the river to fully refill the watering can. 
...
# amount of water the iᵗʰ plant needs, and an integer capacity representing the 
