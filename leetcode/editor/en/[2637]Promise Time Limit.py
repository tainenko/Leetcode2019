...
# unless it takes longer than t milliseconds to fullfill. In that case, it will reject 
# with "Time Limit Exceeded". Note that it should reject with a string, not an 
# Error. 
# 
#  
#  Example 1: 
