...
# n (at the end of the line) in a line of n + 1 people (numbered from 0 to n). 
# 
#  You wish to move forward in the line, but each person in front of you 
# charges a specific amount to swap places. The cost to swap with person i is given by 
# cost[i]. 
# 
