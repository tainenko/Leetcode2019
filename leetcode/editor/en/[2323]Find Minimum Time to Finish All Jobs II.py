...
# </ul>
# 
# <div><div>Related Topics</div><div><li>Array</li><li>Greedy</li><li>Sorting</li></div></div><br><div><li>👍 43</li><li>👎 12</li></div>
import math
...
class Solution:
    def minimumTime(self, jobs: List[int], workers: List[int]) -> int:
        jobs.sort()
        workers.sort()
        return max(math.ceil(job / worker) for job, worker in zip(jobs, workers))
