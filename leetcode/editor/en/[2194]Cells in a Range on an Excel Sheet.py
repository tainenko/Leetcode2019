...
# 
#  
#  For example, the 1ˢᵗ column is denoted by 'A', the 2ⁿᵈ by 'B', the 3ʳᵈ by 
# 'C', and so on. 
#  
#  
#  <row> is the row number r of the cell. The rᵗʰ row is represented by the 
# integer r. 
# 
# 
#  You are given a string s in the format "<col1><row1>:<col2><row2>", where <
# col1> represents the column c1, <row1> represents the row r1, <col2> represents 
