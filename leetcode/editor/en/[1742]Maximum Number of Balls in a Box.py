...
# lowLimit up to highLimit inclusive (i.e., n == highLimit - lowLimit + 1), and an 
# infinite number of boxes numbered from 1 to infinity. 
# 
...
#  
#  Related Topics Hash Table Math Counting 👍 360 👎 83
