...
# where 0 <= j <= n - 2. Note that the difference between two letters is the 
# difference between their positions in the alphabet i.e. the position of 'a' is 0, 'b' is 
# 1, and 'z' is 25. 
# 
#  
...
#  
# 
#  Related Topics Hash Table Math String 👍 171 👎 64
