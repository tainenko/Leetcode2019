...
# given a 0-indexed integer array damage where damage[i] is the amount of health you 
# will lose to complete the iᵗʰ level. 
# 
...
#  
# 
#  Related Topics Array Greedy Prefix Sum 👍 290 👎 218
