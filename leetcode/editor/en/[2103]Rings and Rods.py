...
# are placed onto the rods. Every two characters in rings forms a color-position 
# pair that is used to describe each ring where: 
# 
#  
#  The first character of the iᵗʰ pair denotes the iᵗʰ ring's color ('R', 'G', 
# 'B'). 
#  The second character of the iᵗʰ pair denotes the rod that the iᵗʰ ring is 
# placed on ('0' to '9'). 
#  
# 
