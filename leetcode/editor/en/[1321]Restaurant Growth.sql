...
#visited_on is the date on which the customer with ID (customer_id) has visited 
#the restaurant.
...
#paid in a seven days window (i.e., current day + 6 days before). average_amount 
...
#+--------------+--------------+----------------+
#Explanation: 
#1st moving average from 2019-01-01 to 2019-01-07 has an average_amount of (100 
#+ 110 + 120 + 130 + 110 + 140 + 150)/7 = 122.86
#2nd moving average from 2019-01-02 to 2019-01-08 has an average_amount of (110 
#+ 120 + 130 + 110 + 140 + 150 + 80)/7 = 120
#3rd moving average from 2019-01-03 to 2019-01-09 has an average_amount of (120 
#+ 130 + 110 + 140 + 150 + 80 + 110)/7 = 120
#4th moving average from 2019-01-04 to 2019-01-10 has an average_amount of (130 
