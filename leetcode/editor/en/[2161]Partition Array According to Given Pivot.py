...
# element and pj is the new position of the jᵗʰ element. For elements less than 
# pivot, if i < j and nums[i] < pivot and nums[j] < pivot, then pi < pj. Similarly 
# for elements greater than pivot, if i < j and nums[i] > pivot and nums[j] > 
# pivot, then pi < pj. 
#  
#  
# 
...
#  
# 
#  Related Topics Array Two Pointers Simulation 👍 872 👎 65
