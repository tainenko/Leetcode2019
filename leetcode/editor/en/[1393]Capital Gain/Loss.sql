...
#'Buy' operation in a previous day. It is also guaranteed that each 'Buy' operation 
#for a stock has a corresponding 'Sell' operation in an upcoming day.
# 
#
# 
#
...
#gain/loss is the sum of capital gains/losses for each ('Buy' --> 'Sell') operation 
#= (1010 - 10) + (500 - 1000) + (10000 - 1000) = 1000 - 500 + 9000 = 9500$.
# 
#
# Related Topics Database 👍 693 👎 41
