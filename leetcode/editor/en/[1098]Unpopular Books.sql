...
#in the last year, excluding books that have been available for less than one 
...
# 
#
# Related Topics Database 👍 187 👎 554
...
from books
left join orders on orders.book_id=books.book_id and orders.dispatch_date between '2018-06-23' and '2019-06-23'
