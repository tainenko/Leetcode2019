...
# val. If there are less than k elements in the stack, increment all the elements in 
# the stack. 
#  
# 
#  
...
#  
# 
#  Related Topics Array Stack Design 👍 1655 👎 86
...
class CustomStack:
    ...
    def increment(self, k: int, val: int) -> None:
        for i in range(min(len(self.stack), k) - 1, -1, -1):
            self.stack[i] += val
