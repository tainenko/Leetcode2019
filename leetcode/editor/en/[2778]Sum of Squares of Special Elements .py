...
# divides 6, nums[2] since 2 divides 6, nums[3] since 3 divides 6, and nums[6] since 
# 6 divides 6. 
# Hence, the sum of the squares of all special elements of nums is nums[1] * 
# nums[1] + nums[2] * nums[2] + nums[3] * nums[3] + nums[6] * nums[6] = 2 * 2 + 7 * 7
#  + 1 * 1 + 3 * 3 = 63. 
#  
# 
#  
...
#  
# 
#  Related Topics Array Simulation 👍 93 👎 15
