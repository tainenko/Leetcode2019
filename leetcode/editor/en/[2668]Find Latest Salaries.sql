...
#Each row contains employees details and their yearly salaries, however, some 
#of the records are old and contain outdated salary information. 
# 
#
# Write an SQL query to find the current salary of each employee assuming that 
