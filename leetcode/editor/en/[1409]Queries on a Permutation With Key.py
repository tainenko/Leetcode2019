...
# process all queries[i] (from i=0 to i=queries.length-1) according to the following 
# rules: 
# 
#  
#  In the beginning, you have the permutation P=[1,2,3,...,m]. 
#  For the current i, find the position of queries[i] in the permutation P (
# indexing from 0) and then move this at the beginning of the permutation P. Notice 
# that the position of queries[i] in P is the result for queries[i]. 
#  
# 
...
#  
# 
#  Related Topics Array Binary Indexed Tree Simulation 👍 443 👎 601
