...
# boundary, and the right boundary is empty if the root does not have a right child. 
# 
...
# Concatenating everything results in [1] + [2] + [4,7,8,9,10] + [6,3] = [1,2,4,
# 7,8,9,10,6,3].
#  
# 
#  
...
#  
# 
#  Related Topics Tree Depth-First Search Binary Tree 👍 1238 👎 1987
