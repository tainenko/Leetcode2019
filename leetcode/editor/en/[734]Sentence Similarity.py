...
# similarity relation is not transitive. For example, if the words a and b are similar, 
...
#  
#  Related Topics Array Hash Table String 👍 264 👎 411
...
class Solution:
    def areSentencesSimilar(self, sentence1: List[str], sentence2: List[str], similarPairs: List[List[str]]) -> bool:
        ...
        for key, val in similarPairs:
            similar_map[key].append(val)
            similar_map[val].append(key)
