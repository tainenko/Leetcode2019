...
# seen that nums is a permutation of base[3] = [1, 2, 3, 3] (by swapping the second 
# and fourth elements in nums, we reach base[3]). Therefore, the answer is true. 
# 
#  Example 3: 
# 
#  
...
# seen that nums is a permutation of base[1] = [1, 1]. Therefore, the answer is true.
#  
# 
#  Example 4: 
# 
