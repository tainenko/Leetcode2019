...
# the number of ways to select a total amount i using an infinite supply of some 
# fixed coin denominations. Each denomination is a positive integer with value at 
# most numWays.length. 
# 
#  However, the exact coin denominations have been lost. Your task is to 
# recover the set of denominations that could have resulted in the given numWays array. 
# 
...
#  
# 
#  Related Topics Array Dynamic Programming 👍 117 👎 11
