...
# length n, where seats[i] is the position of the iᵗʰ seat. You are also given the 
...
# 
#  
#  Increase or decrease the position of the iᵗʰ student by 1 (i.e., moving the 
# iᵗʰ student from position x to x + 1 or x - 1) 
#  
# 
...
#  
# 
#  Related Topics Array Sorting 👍 410 👎 73
