...
# by a 0-indexed integer array buckets, where the iᵗʰ bucket contains buckets[i] 
...
# amount of water from one bucket to another bucket (not necessarily an integer). 
# However, every time you pour k gallons of water, you spill loss percent of k. 
# 
#  Return the maximum amount of water in each bucket after making the amount of 
# water equal. Answers within 10⁻⁵ of the actual answer will be accepted. 
# 
#  
#  Example 1: 
# 
...
#  
# 
#  Related Topics Array Binary Search 👍 88 👎 8
