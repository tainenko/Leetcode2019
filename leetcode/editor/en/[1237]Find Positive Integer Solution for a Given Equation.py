...
# reverse engineer the formula and return all positive integer pairs x and y where f(x,y)
...
#  
# 
#  Related Topics Math Two Pointers Binary Search Interactive 👍 476 👎 1377
