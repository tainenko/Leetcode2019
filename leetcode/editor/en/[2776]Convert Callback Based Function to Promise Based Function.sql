...
#first argument and also any additional arguments. It returns a new function that 
#returns a promise instead. The returned promise should resolve with the result 
...
#the promise is rejected with a error message provided in the callback. Note that 
#it did not matter what was passed as the first argument into the callback.
# 
#
# 
# Constraints: 
