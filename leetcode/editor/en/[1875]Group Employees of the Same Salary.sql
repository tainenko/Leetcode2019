...
#the other teams' salaries, where the team with the lowest salary has team_id = 1. 
#Note that the salaries for employees not on a team are not included in this 
#ranking. 
# 
#
# Write an SQL query to get the team_id of each employee that is in a team. 
#
# Return the result table ordered by team_id in ascending order. In case of a 
#tie, order it by employee_id in ascending order. 
#
...
#they have the same salary of 3000.
...
#is unique (i.e. no other employee has the same salary).
#The team IDs are assigned as follows (based on salary ranking, lowest first):
#- team_id=1: Meir and Michael, a salary of 3000
#- team_id=2: Addilyn and Kannon, a salary of 7400
#Juan's salary of 6100 is not included in the ranking because they are not on a 
#team.
# 
#
# Related Topics Database 👍 62 👎 5
