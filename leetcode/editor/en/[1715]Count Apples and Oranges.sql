...
#apples they have. Each box may include a chest, which also can contain oranges 
#and apples.
# 
#
# 
...
#This table contains information about the chests and the corresponding number 
#of oranges and apples they have.
# 
#
# 
#
...
#5 oranges.
#box 19 has 8 + 19 (from the chest) = 27 apples and 4 + 4 (from the chest) = 8 
#oranges.
...
#oranges.
#box 8 has 9 + 5 (from the chest) = 14 apples and 9 + 6 (from the chest) = 15 
#oranges.
...
# 
#
# Related Topics Database 👍 72 👎 18


#leetcode submit region begin(Prohibit modification and deletion)
# Write your MySQL query statement below

select sum(COALESCE(boxes.apple_count,0)+COALESCE(chests.apple_count,0)) apple_count, sum(COALESCE(boxes.orange_count,0)+COALESCE(chests.orange_count,0)) orange_count
from boxes
