...
# hyphens ('-'), punctuation marks ('!', '.', and ','), and spaces (' ') only. Each 
# sentence can be broken down into one or more tokens separated by one or more 
# spaces ' '. 
# 
